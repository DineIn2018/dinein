...
var Deploy = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                plugin.deploy.init(config, function (res) {
                                    resolve();
                                }, function (err) {
                                    reject(err);
                                });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        plugin = _a.sent();
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                plugin.deploy.info(function (res) {
                                    resolve(res);
                                }, function (err) {
                                    reject(err);
                                });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        plugin = _a.sent();
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                plugin.deploy.check(function (res) {
                                    if (res === 'true') {
                                        resolve(true);
                                    }
                                    else {
     ...
     */
    Deploy.prototype.download = function (progressFunc) {
        return __awaiter(this, void 0, void 0, function () {
            var plugin;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        plugin = _a.sent();
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                plugin.deploy.download(function (res) {
                                    if (res === 'true') {
                                        resolve();
                                    }
                                    else {
     ...
     * @return {Promise} resolves when completed
     */
    Deploy.prototype.extract = function (progressFunc) {
        return __awaiter(this, void 0, void 0, function () {
            var plugin;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        plugin = _a.sent();
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                plugin.deploy.extract(function (res) {
                                    if (res === 'done') {
                                        resolve();
                                    }
                                    else {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        plugin = _a.sent();
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                plugin.deploy.redirect(function (res) {
                                    resolve(res);
                                }, function (err) {
                                    reject(err);
                                });
     ...
     */
    Deploy.prototype.checkAndApply = function (redirect, downloadProgressFunc, extractProgressFunc) {
        if (redirect === void 0) { redirect = false; }
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        var hasUpdate, downloaded, extract, redirect_1;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.check()];
                                case 1:
                                    hasUpdate = _a.sent();
                                    if (!hasUpdate) return [3 /*break*/, 7];
                                    return [4 /*yield*/, this.download(downloadProgressFunc)];
                                case 2:
                                    downloaded = _a.sent();
                                    return [4 /*yield*/, this.extract(extractProgressFunc)];
                                case 3:
                                    extract = _a.sent();
                                    if (!redirect) return [3 /*break*/, 5];
                                    return [4 /*yield*/, this.redirect()];
                                case 4:
                                    redirect_1 = _a.sent();
                                    resolve({ 'update': true, 'redirected': true });
                                    return [3 /*break*/, 6];
                                case 5:
                                    resolve({ 'update': true, 'redirected': false });
                                    _a.label = 6;
                                case 6: return [3 /*break*/, 8];
                                case 7:
                                    resolve({ 'update': false, 'redirected': false });
                                    _a.label = 8;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        plugin = _a.sent();
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                plugin.deploy.getVersions(function (res) {
                                    resolve(res);
                                }, function (err) {
                                    reject(err);
                                });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        plugin = _a.sent();
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                plugin.deploy.deleteVersion(uuid, function (res) {
                                    resolve();
                                }, function (err) {
                                    reject(err);
                                });
