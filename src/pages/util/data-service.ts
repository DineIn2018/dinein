...
export class DataService {
    ...
    let tempEmployees =
    	[
				...
				new Employee("Marianne", "Beaumont", "Host/Hostess", 15.00, 9119119911,
				...
				new Employee("Kameron", "Young", "Server", 10.00, 6088067777,
				...
				new Employee("Casey", "Nitz", "Server", 11.00, 6096084456,
				...
				new Employee("Suzy", "Kong", "Server", 12.00, 5938377872,
				...
				new Employee("Jimmie", "Plautz", "Server", 13.00, 6087299485,
										 "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSYKzL4WtUsWpaDI_PkYH01KiEEwByV8JDplXwvdvJfrnEYa330"),
				new Employee("Kass", "Chupongstimun", "Server", 14.00, 6086095186,
				...
				new Employee("Tina", "Russo", "Chef", 500.00, 4149217439,
			...
			for (i = 0; i < this.restaurant.employees.length; i++) {
				this.restaurant.employees[i].shifts =
					[
						new EmployeeShift("04/15/2018 07:00", "04/15/2018 12:00", this.restaurant.employees[i].getFullName()),
						new EmployeeShift("04/15/2018 15:00", "04/15/2018 21:00", this.restaurant.employees[i].getFullName()),
						new EmployeeShift("04/16/2018 07:30", "04/16/2018 11:00", this.restaurant.employees[i].getFullName()),
						new EmployeeShift("04/16/2018 17:00", "04/16/2018 23:00", this.restaurant.employees[i].getFullName()),
						new EmployeeShift("04/17/2018 10:00", "04/17/2018 14:00", this.restaurant.employees[i].getFullName()),
						new EmployeeShift("04/17/2018 18:00", "04/17/2018 23:30", this.restaurant.employees[i].getFullName()),
						new EmployeeShift("04/18/2018 20:00", "04/19/2018 02:00", this.restaurant.employees[i].getFullName()),
						new EmployeeShift("04/20/2018 04:20", "04/20/2018 16:20", this.restaurant.employees[i].getFullName()),
						new EmployeeShift("04/21/2018 18:30", "04/21/2018 22:15", this.restaurant.employees[i].getFullName()),
						new EmployeeShift("04/22/2018 07:00", "04/22/2018 12:00", this.restaurant.employees[i].getFullName()),
						new EmployeeShift("04/23/2018 15:30", "04/23/2018 20:15", this.restaurant.employees[i].getFullName()),
						new EmployeeShift("04/24/2018 18:15", "04/24/2018 23:45", this.restaurant.employees[i].getFullName()),
						new EmployeeShift("04/25/2018 18:45", undefined, this.restaurant.employees[i].getFullName())
					];
			}
