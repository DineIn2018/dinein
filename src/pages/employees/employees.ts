...
export class EmployeesPage {
  ...
  employee1: Employee;
  employee2 = new Employee("Carl", "Robins", 4321, "Assistant Manager", 30, "(608) 345-1209", "http://www.math.uni-frankfurt.de/~person/_4170854.jpg");
  employee5 = new Employee("Marianne", "Beaumont", 9902, "Hostess", 15, "+33 8 92 70 12 39", "http://www.pearsonvue.com/pteprofessional/images/homepage.png");
  employee6 = new Employee("Anna", "Schmidt", 4312, "Manager", 50, "+49 30 2273 2152", "https://i.pinimg.com/736x/25/48/31/25483183a26a96adcc2b5a4002eda6ca--headshot-ideas-professional-photographer.jpg");
  employee7 = new Employee("Valerie", "Carter", 1, "Owner", 1003, "(202) 456-1111", "https://cdn10.phillymag.com/wp-content/uploads/2016/01/woman-biz.jpg");
  employee8 = new Employee("Phil", "Scott", 8156, "Bartender", 10, "(608) 310-4545", "https://upload.wikimedia.org/wikipedia/commons/thumb/0/02/Robert_gold_bartender.jpg/220px-Robert_gold_bartender.jpg");
  employee3: Employee;
  employee4: Employee;
  ...
  constructor(public navCtrl: NavController,
    ...
    this.employee1 = new Employee("Kevin", "Anderson", 1234, "Server", 5, "(608) 329-4565", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxhJ8HaQ88jGA0Ws2WTCnI4DzSgMzvEXk4qdbQVbCAiKyP9yGl");
    this.employee3 = new Employee("Tina", "Russo", 5678, "Head Chef", 500, "(414) 921-4980", "https://cdn2.goabroad.com/images/program_content/5-tips-for-teaching-english-abroad-as-a-person-of-color-2-1462426680.jpg")
    this.employee4 = new Employee("Bryan", "Suzan", 666, "DJ", 0.03, "1-866-436-5706", "../../assets/imgs/bryan.jpg")
...
export class Employee {
  ...
  constructor(firstName: string, lastName: string, ID: number,
              title: string, pay: number, phone: string, imageSrc?: string) {
